...
@section('content')
    ...
    <section class="hero">
        <div class="container">
            <div class="row">
                ...
                <div data-aos="fade-left" class="col-lg-9">
                    <div data-aos="fade-down" data-aos-delay="100" class="hero__search">
    ...
    <section data-aos="fade-up" class="categories">
        <div class="container">
            <div class="row">
    ...
    <section data-aos="fade-up" class="featured spad">
        <div class="container">
            <div class="row">
    ...
    <div class="banner">
        <div class="container">
            <div class="row">
                <div data-aos="zoom-in" class="col-lg-6 col-md-6 col-sm-6">
    ...
    <section data-aos="fade-up" class="latest-product spad">
        <div class="container">
            <div class="row">
                <div data-aos="fade-up-right" class="col-lg-4 col-md-6">
                    <div class="latest-product__text">
                        <h4 data-aos="fade-right">Latest Products</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="latest-product__text">
                        <h4 data-aos="zoom-in">Top Rated Products</h4>
                        <div class="latest-product__slider owl-carousel">
                            <div class="latest-prdouct__slider__item">
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                ...
                <div data-aos="fade-up-left" class="col-lg-4 col-md-6">
                    <div class="latest-product__text">
                        <h4 data-aos="fade-left">Review Products</h4>
                        <div class="latest-product__slider owl-carousel">
                            <div class="latest-prdouct__slider__item">
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
