...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/front/css/aos.css') }}" type="text/css">
...
<body>
    ...
    <header class="header">
        <div data-aos="fade-down" class="header__top">
            <div class="container">
                <div class="row">
    ...
    <footer data-aos="fade-up" class="footer spad">
        <div class="container">
            <div class="row">
                <div data-aos="fade-right" class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="{{ asset('uploads/' . $setting->logo) }}" alt=""></a>
                        </div>
                        <ul>
